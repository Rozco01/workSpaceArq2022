...
public class ConexionServicioWebRESTImpl implements IConexionServicioWeb{
    ...
    public void conectarServicio() {
        System.out.println("Conexion Generica A Servicion Web Rest obtenida.");
    }
    ...
    System.out.println("Desconexion Generica A Servicion REST.");
    }

    @Override
    public String toString() {
        return "ConexionServicioWebRESTImpl{" + "url=" + url + ", parametrosE=" + parametrosE + ", parametrosS=" + parametrosS + '}';
    }
